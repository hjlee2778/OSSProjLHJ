        ...
        <Dialog.Content asChild>
          <Styled.Content>
            ...
            <Styled.RoadmapContainer>
              <Styled.Item
                onClick={() => {
                  router.push(DUEL_LINKS.manageInfo(roadmapId));
                  setOpen(false);
                }}>
                로드맵 정보
              </Styled.Item>
              <Styled.Item
                onClick={() => {
                  router.push(DUEL_LINKS.manageStep(roadmapId));
                  setOpen(false);
                }}>
                STEP 관리
              </Styled.Item>
              <Styled.Item
                onClick={() => {
                  router.push(DUEL_LINKS.manageMember(roadmapId));
                  setOpen(false);
                }}>
                구성원 관리
              </Styled.Item>
              <Styled.Item
                onClick={() => {
                  router.push(DUEL_LINKS.manageTIL(roadmapId));
                  setOpen(false);
                }}>
                TIL 모아보기
              </Styled.Item>
              <Styled.Item
                onClick={() => {
                  router.push(DUEL_LINKS.manageApply(roadmapId));
                  setOpen(false);
                }}>
                신청 관리
              </Styled.Item>
