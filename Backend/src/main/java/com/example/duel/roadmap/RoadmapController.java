...
public class RoadmapController {
    ...
    public ResponseEntity<?> findRoadmap(@PathVariable("roadmapId") Long roadmapId, @AuthenticationPrincipal CustomUserDetails userDetails){
    ...
    public ResponseEntity<?> deleteRoadmap(@PathVariable("roadmapId") Long roadmapId, @AuthenticationPrincipal CustomUserDetails userDetails){
    ...
    public ResponseEntity<?> applyDuelRoadmap(@PathVariable("roadmapId") Long roadmapId, @AuthenticationPrincipal CustomUserDetails userDetails){
    ...
    public ResponseEntity<?> findRoadmapMembers(@PathVariable("roadmapId") Long roadmapId, @AuthenticationPrincipal CustomUserDetails userDetails){
    ...
    public ResponseEntity<?> changeMemberRole(@RequestBody @Valid RoadmapRequest.ChangeMemberRoleDTO requestDTO, Errors errors,
                                              @PathVariable("roadmapId") Long roadmapId, @PathVariable Long memberId,
                                              @AuthenticationPrincipal CustomUserDetails userDetails){
    ...
    public ResponseEntity<?> dismissMember(@PathVariable("roadmapId") Long roadmapId, @PathVariable Long memberId,
                                           @AuthenticationPrincipal CustomUserDetails userDetails){
    ...
    public ResponseEntity<?> findAppliedUsers(@PathVariable("roadmapId") Long roadmapId, @AuthenticationPrincipal CustomUserDetails userDetails){
    ...
    public ResponseEntity<?> acceptApplication(@PathVariable("roadmapId") Long roadmapId, @PathVariable("memberId") Long memberId, @AuthenticationPrincipal CustomUserDetails userDetails){
    ...
    public ResponseEntity<?> rejectApplication(@PathVariable("roadmapId") Long roadmapId, @PathVariable("memberId") Long memberId,
                                               @AuthenticationPrincipal CustomUserDetails userDetails){
